...
window.SD_EXTENSION_PACKS = [
  ...
  },
  {
    ...
    fileName: "SDFleaMarket_v1.0.1_Desktop.zip",
    downloadUrl: "#",
    unlockDownloadUrl: "downloads/extensions/SDFleaMarket_v1.0.1_Desktop.zip?v=101",
    description: "v1.0.1에서 개발용 지갑을 제거하고 실제 SD지갑 연동으로 전환했으며, 물류센터는 SD 물류회사 S등급만 입장할 수 있게 수정했습니다. 은행 경비 약화 준비작업에는 피날레와 같은 모델의 경비원 3명을 배치했습니다.",
    requirements: "SD종합센터 v2.2.0 이상 · SD 물류회사 S등급 · Windows 10/11",
    updatedAt: "2026-08-16",
    tags: ["S등급 강제", "실제 SD지갑", "경비 약화 경비 3명"],
    featured: true,
