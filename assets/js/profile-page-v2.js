...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const CARD_KEYS = ["photo", "identity", "assets", "gold", "coins", "slot_best"];
  ...
  function renderCardValues() {
    ...
    if (layout.settings.gold_display === "weight") {
      gold.textContent = profile?.assets?.gold_grams == null ? "비공개" : `${number(profile.assets.gold_grams)}g`;
      if (goldNote) goldNote.textContent = "무게 기준";
    } else {
