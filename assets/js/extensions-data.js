...
window.SD_EXTENSION_PACKS = [
  ...
  },
  {
    ...
    fileName: "SDFleaMarket_v1.0.3_Desktop.zip",
    downloadUrl: "#",
    unlockDownloadUrl: "downloads/extensions/SDFleaMarket_v1.0.3_Desktop.zip?v=103",
    description: "v1.0.3에서 PC에서 획득한 플리마켓 아이템을 홈페이지 계정의 온라인 보관함과 동기화해 모바일 플리마켓 판매·시스템 마켓 거래·공개 프로필 자랑 기능과 연결했습니다. v1.0.2의 아이템 획득 효과음과 기존 S등급·SD지갑 연동 규칙도 유지됩니다.",
    requirements: "SD종합센터 v2.2.0 이상 · SD 물류회사 S등급 · Windows 10/11",
    updatedAt: "2026-08-16",
    tags: ["온라인 아이템 동기화", "모바일 판매", "공개 프로필"],
    featured: true,
