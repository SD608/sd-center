...
window.SD_EXTENSION_PACKS = [
  ...
  },
  {
    ...
    fileName: "SDFleaMarket_v1.0.2_Desktop.zip",
    downloadUrl: "#",
    unlockDownloadUrl: "downloads/extensions/SDFleaMarket_v1.0.2_Desktop.zip?v=102",
    description: "v1.0.2에서 아이템 획득 효과음을 추가했습니다. 상자·파밍·은행 준비 장비·은행 금고 보상 획득 시 효과음이 재생되며 고가 아이템은 별도 고음 효과로 구분됩니다. v1.0.1의 실제 SD지갑 연동, 물류센터 S등급 강제, 경비 약화 준비작업 경비원 3명 배치도 유지됩니다.",
    requirements: "SD종합센터 v2.2.0 이상 · SD 물류회사 S등급 · Windows 10/11",
    updatedAt: "2026-08-16",
    tags: ["아이템 획득음", "S등급 강제", "실제 SD지갑"],
    featured: true,
