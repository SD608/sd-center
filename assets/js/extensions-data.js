...
window.SD_EXTENSION_PACKS = [
  ...
  {
    "id": "sd-flea-market-safe-controls-patch",
    "name": "SD 플리마켓 금고 조작 패치",
    "stage": "Safe Controls Patch",
    "version": "v1.0",
    "category": "플리마켓 보조 패치",
    "icon": "assets/icons/flea-market.png?v=3",
    "fileName": "SDFleaMarket_Safe_AD_Mouse_Windows_NoPython.zip",
    "downloadUrl": "downloads/extensions/SDFleaMarket_Safe_AD_Mouse_Windows_NoPython.zip?v=1",
    "description": "플리마켓 금고를 A/D 키로 돌리는 기존 조작에 더해 마우스로 다이얼을 직접 잡아 돌릴 수 있게 하는 Windows용 패치 도구입니다. 다운로드 후 압축을 풀고 BAT 파일 위에 정상 실행되는 플리마켓 ZIP을 끌어다 놓으면 패치된 ZIP이 생성됩니다.",
    "requirements": "정상 실행되는 SD 플리마켓 ZIP · Windows 10/11 · PowerShell",
    "updatedAt": "2026-08-17",
    "tags": ["금고 A/D", "마우스 드래그", "설치 도구 불필요"],
    "featured": true
  }
];
