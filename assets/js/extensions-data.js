...
window.SD_EXTENSION_PACKS = [
  {
    ...
    fileName: "SDLink_v1.2.2_Desktop.zip",
    downloadUrl: "downloads/extensions/SDLink_v1.2.2_Desktop.zip",
    description: "동시 수익 보호 긴급 패치. SD Link의 서버 최종 잔액 강제보정을 제거하고 자기 거래 재감지 루프를 차단해 STA·SD광부·물류센터 등 여러 앱이 동시에 수익을 만들 때 정상 잔액이 깎이는 문제를 수정했습니다. BTC 정확 연동 기능도 유지됩니다.",
    requirements: "SD종합센터 v2.1.1 이상 · SD지갑 · Windows 10/11",
    updatedAt: "2026-08-13",
    tags: ["동시 수익 보호", "PC·모바일 연동", "BTC 정확 연동"],
    featured: true
  },
  {
    id: "sd-slot",
