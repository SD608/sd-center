...
const card=a=>{if(a.h)return`<article class="achievement-card hidden-achievement"><div class="achievement-top"><div class="achievement-icon">❔</div><span class="achievement-badge hidden-badge">HIDDEN</span></div><h3 class="achievement-name">???</h3><div class="achievement-condition"><small>달성 방법</small><strong>???</strong></div></article>`;
