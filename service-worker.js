"use strict";
const CACHE_NAME = "sd608-mobile-v24-profile-edit-consolidated";
const APP_SHELL = [
  "./mobile.html",
  "./wallet-mobile.html",
  "./vault-mobile.html",
  ...
  "./profile-card-edit.html?embed=1&v=5",
  "./profile-shop.html",
  "./login.html",
  "./signup.html",
  "./offline.html",
  ...
  "./assets/js/profile-page-v5.js?v=1",
  "./assets/js/profile-card-edit-v5.js?v=1",
