...
body[data-preview-theme="casino"] .preview-theme-home-scene-secondary{right:40px;top:34px;width:88px;height:7px;border:0;border-radius:8px;background:#6d4ef1;box-shadow:0 0 14px rgba(109,78,241,.55),0 18px 0 #d37bff,0 18px 14px rgba(211,123,255,.35)}
