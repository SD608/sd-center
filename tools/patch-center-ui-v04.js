...
if (!root) throw new Error("Usage: node patch-center-ui-v04.js <app-root>");
...
if (!main.includes("Menu.setApplicationMenu(null);")) {
  main = replaceOnce(
    ...
    `    // UI Preview v0.4: Electron 기본 메뉴를 완전히 제거해 Alt 키로 메뉴바가 나타나지 않게 합니다.\n    Menu.setApplicationMenu(null);\n    mainWindow.setMenuBarVisibility(false);\n    mainWindow.removeMenu();\n\n    mainWindow.webContents.setWindowOpenHandler(() => ({`,
...
console.log("SDCenter UI Preview v0.4 compatibility patch applied");
