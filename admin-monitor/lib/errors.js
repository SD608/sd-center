...
const ERROR_MESSAGES = Object.freeze({
  ...
  INVALID_AMOUNT: "금액은 1 이상 10억 이하로 입력하세요.", INSUFFICIENT_FUNDS: "잔액이 부족합니다.", WALLET_TARGET_NOT_FOUND: "대상 지갑을 찾지 못했습니다.",
...
function extractCode(value) {
  if (!value) return "";
  const text = typeof value === "string" ? value : String(value.message || value.error_description || value.error || "");
